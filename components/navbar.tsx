    ...
    <div className="h-[90px] w-full flex flex-row items-center justify-between px-10">
      <div className="w-[350px] relative">
        ...
        {recommededData.length > 0 && (
          <div className="absolute top-[50px] w-full bg-white shadow-lg rounded-[10px] max-h-[500px]">
            {recommededData.map((data: any) =>
              user.role === "finance" ? (
                ...
                <div
                  className="flex flex-row items-center gap-2 p-2 hover:bg-slate-400/10 bg-white max-h-[500px]"
                  key={data.id}
                >
                  <Image
